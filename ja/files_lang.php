...
$lang = array (
	...
	'c_files_upload_error_del_original' => 'オリジナルファイルの削除エラー。アップロードフォルダの権限を確認してください。',
	'c_files_tpm_file_not_exists'	=> 'このファイルが存在しないか、アクセスできません。',
	'c_files_del'					=> 'ファイルの削除',
	'c_files_del_cannot_del'		=> 'ファイルを削除できません。',
	'c_files_del_error'				=> 'ファイルを削除する際にエラーが発生しました。',
	'c_files_error_csrf' 			=> 'エラー：CSRFの検証です。再度お試しください',
	'c_files_edit_notes'			=> 'ファイルノートの編集',
	'c_files_edit_notes_perm'		=> 'このファイルノートを編集することはできません。',
	...
	'm_files_upload_folder_missing' => 'アップロードフォルダがありません。',
	'm_files_upload_folder_must_exist' => 'パスワードまたは[PRJS]にファイルをアップロードするには、アップロードフォルダが存在し、書き込み可能でなければなりません。',
	'm_files_upload_check_config'	=> 'config.phpファイルを確認してください。',
	'm_files_upload_folder_not_writable' => 'アップロードフォルダが書き込みできません。',
	'm_files_upload_folder_must_writable' => 'パスワードまたは[PRJS]にファイルをアップロードするには、アップロードフォルダが書き込み可能でなければなりません。',
	'm_files_upload_folder_set_writable' => '書き込み可能に設定してください。',

	// views/files
	'vfiles_del_confirm'			=> 'ファイルを削除しますか？',
	'vfiles_del_warning'			=> '警告：このアクションは永続的であり、取り消すことはできません。',
	...
	'vfiles_upload_encrypting'		=> 'ファイルを暗号化しています。しばらくお待ちください',
