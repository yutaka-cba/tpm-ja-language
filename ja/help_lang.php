...
$lang = array (
	...
	'v_help_adm_11'		=> '一般的な活動記録を見る',

	'v_help_pm_1'		=> '[PRJS]内にパスワードを作成する。<strong>に適切な許可を得ている。</strong>',
	'v_help_pm_2'		=> '[PRJS]の作成とセキュリティ管理',
	'v_help_pm_3'		=> '以下の[PRJS]のパスワードを表示する。<strong>を許可している。</strong>パスワードを管理する（適切な権限がある場合）。',
	'v_help_pm_4'		=> '[PRJS]の表示と管理<strong>を許可している。</strong>',
	'v_help_pm_5'		=> 'アクセス可能なパスワードと管理する[PRJS]のアクティビティログの表示',

	'v_help_it_1'		=> 'アクセス可能なパスワードのエクスポート、またはパスワードのインポート',
	'v_help_it_2'		=> 'あなたがアクセスできるパスワードまたは[PRJ]、またはすべてのユーザーのアクティビティログを表示する。',

	'v_help_ro_1'		=> '読み取り専用ユーザーとして、他のユーザーが作成したパスワードのみを読み取ることができます。',

	'v_help_normal_1'	=> '[PRJS]内にパスワードを作成する。<strong>を許可する。</strong>',
	'v_help_normal_2'	=> '以下の[PRJS]のパスワードを表示する。<strong>を許可する。</strong>パスワードを管理する（適切な権限がある場合）。',
	'v_help_normal_3'	=> '以下の[PRJS]またはアーカイブ[PRJS]をご覧ください。<strong>を許可する。</strong>',
	'v_help_normal_4'	=> '以下の[PRJS]を管理する（削除しない）。<strong>を許可する。</strong>',
	'v_help_normal_5'	=> 'アクセス可能なパスワードと管理する[PRJS]のアクティビティログを表示する。',
