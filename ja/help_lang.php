...
$lang = array (
	...
	'v_help_intro'		=> 'はじめに',
	'v_help_intro_1'	=> '<strong>Team Password Manager</strong>はパスワードの管理に役立ちます。各パスワードは<strong>[PRJ]</strong>に属します。',
	'v_help_intro_2'	=> 'トップメニューの[ホーム]をクリックすると、パスワードと[PRJS]が表示されます。',

	'v_help_role_1'		=> 'あなたのロール',
	'v_help_role_2'		=> 'Team Password Managerのすべてのユーザにはロールがあります。あなたの役割は',
	'v_help_role'		=> 'このロールでは、以下のことが可能です。',

	'v_help_adm_1'		=> '管理者として、Team Password Managerのすべてのオプションにアクセスできます。以下のことができます。',
	'v_help_adm_2'		=> '任意の[PRJ]内でパスワードを作成する',
	'v_help_adm_3'		=> '[PRJS]の作成とセキュリティ管理',
	'v_help_adm_4'		=> 'パスワードの管理（編集、削除、コピー、移動など）',
	'v_help_adm_5'		=> '任意の[PRJ]またはアーカイブされた[PRJ]を管理する（編集、削除、アーカイブなど）。',
	'v_help_adm_6'		=> 'ユーザーの作成と管理',
	'v_help_adm_7'		=> 'ユーザーグループの作成と管理',
	'v_help_adm_8'		=> '設定の管理',
	'v_help_adm_9'		=> 'パスワードのエクスポートまたはインポート',
	'v_help_adm_10'		=> 'パスワード、[PRJ]、またはユーザーのアクティビティログを表示する。',
	'v_help_adm_11'		=> '一般的なアクティビティログを表示する',

	'v_help_pm_1'		=> '<strong>適切な権限を持っている</strong>[PRJS]内でパスワードを作成する',
	'v_help_pm_2'		=> '[PRJS]の作成とセキュリティの管理',
	'v_help_pm_3'		=> '<strong>適切な権限を持っている</strong>[PRJS]のパスワードを表示し、そのパスワードを管理する。（適切な権限を持っている場合）',
	'v_help_pm_4'		=> '<strong>適切な権限を持っている</strong>[PRJS]の表示と管理。',
	'v_help_pm_5'		=> 'アクセスできるパスワードと管理している[PRJS]のアクティビティログを表示',

	'v_help_it_1'		=> 'アクセス可能なパスワードのエクスポート、またはパスワードのインポート',
	'v_help_it_2'		=> 'あなたがアクセスできるパスワードまたは[PRJ]、またはすべてのユーザーのアクティビティログを表示',

	'v_help_ro_1'		=> '読み取り専用ユーザーとして、他のユーザーが作成したパスワードのみを読み取ることができます。',

	'v_help_normal_1'	=> '<strong>権限を持っている</strong>[PRJS]内でパスワードを作成する',
	'v_help_normal_2'	=> '<strong>権限を持っている</strong>[PRJS]のパスワードを作成し、管理する。（適切な権限を持っている場合）',
	'v_help_normal_3'	=> '<strong>権限を持っている</strong>[PRJS]またはアーカイブ[PRJS]を表示',
	'v_help_normal_4'	=> '<strong>権限を持っている</strong>[PRJS]を管理する。（しかし削除しない）',
	'v_help_normal_5'	=> 'アクセスできるパスワードと管理している[PRJS]のアクティビティログを表示',

	'v_help_my_account' => 'また、メールアドレス、名前、パスワードは、マイアカウント画面からいつでも変更することができます。',

	'v_help_prj_1'		=> '[PRJ] セキュリティ',
	'v_help_prj_2'		=> '[PRJ] は、それを作成したユーザによって所有されます。作成できるのは、管理者、[CAP_PRJ] 管理者、または IT ユーザーのみです。',
	'v_help_prj_3'		=> '[PRJ]は、すべてのユーザーに特定の権限を与えることも、特定のユーザーまたはユーザーグループにのみ権限を与えることもできます。',
	'v_help_prj_4'		=> '[PRJ]の管理者（または任意の管理者）は、[PRJ]内の任意のパスワードを管理（編集、削除、コピー、移動など）することができます。',
	'v_help_prj_5'		=> '[PRJ]の管理者（または任意の管理者）は、[PRJ]の管理（編集、削除など）やアーカイブ/アンアーカイブを行うことができますが、一般ユーザーは[PRJ]を削除することはできません。',
	...
	'v_help_arch_4'		=> '[PRJ]をアーカイブするには、[PRJ]画面の「アーカイブ」ボタンをクリックしてください。また、[PRJ]画面の[アーカイブ解除]ボタンをクリックすると、[PRJ]のアーカイブを解除することができます。',
	
	// Advanced Search Help
	'c_help_adv_title'		=> '高度な検索ヘルプ',

	'v_help_adv_desc_1'		=> 'を検索する場合<strong>パスワード</strong>を使用することができます。<strong>オペレーター</strong>を使用すると、検索結果を絞り込むことができます。検索演算子は、パスワードをすばやく正確に検索するための特別な単語です。検索演算子は、メインのパスワードリスト検索ボックス、[PRJ]内のパスワード検索ボックス、およびマイパスワードリスト検索ボックスで使用できます。',
	...
	'v_help_adv_project_desc' => '[PRJ]内のパスワード検索ボックス',
	'v_help_adv_my'			=> '私の',
	'v_help_adv_my_desc'	=> 'マイパスワードリスト検索ボックス',
	'v_help_adv_or'			=> 'または',
	...
	'v_help_exp_access'		=> 'アクセス情報',
	'v_help_exp_username'	=> 'ユーザー名',
	'v_help_exp_email'		=> '電子メール',
	'v_help_exp_pwd'		=> 'パスワード（非暗号化）',
	'v_help_exp_notes'		=> '備考',
	'v_help_exp_tags'		=> 'タグ（カンマ区切り）',
	'v_help_exp_cfnames'	=> 'カスタムフィールド名（カンマ区切り）',
	'v_help_exp_cf1'		=> 'カスタムフィールド1（非暗号化）',
	'v_help_exp_cf10'		=> 'カスタムフィールド10（非暗号化）',
	'v_help_exp_edate'		=> '有効期限',
	...
	'v_help_imp_my_how_3'	=> 'パスワード名がすでに存在する場合は、インポートされません。',
	'v_help_imp_my_how_4'	=> 'ご覧の通り、データベース内の情報は上書きされず、新しいパスワードだけがインポートされます。',
	...
	//'v_help_adv_def_is_active' 	=> '有効なパスワードのみ（アーカイブされていないもの）を検索する',
	//'v_help_adv_def_is_archived' => 'アーカイブされたパスワードのみを検索する',
	//'v_help_adv_def_is_favorite' => '検索を行うユーザーの）お気に入りのパスワードのみを検索する',
	//'v_help_adv_def_is_locked' 	=> 'ロックされたパスワードのみを検索',

	'v_help_adv_def_is_linked' => 'リンクされたパスワードの検索',
	'v_help_adv_def_is_not_linked' => 'リンクされていないパスワードを検索する（リンクされているパスワードがあるかどうか）',
	'v_help_adv_def_has_linked' => 'リンクされているパスワードを検索する',

	// v21
	'v_help_adv_strength'	=> '強度が1から4のパスワードを検索します。1=非常に弱い、2=弱い、3=良い、4=強いです。以下の強度名も使用できます：',
