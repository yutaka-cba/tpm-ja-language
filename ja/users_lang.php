...
$lang = array (
	...
	'c_users_need_more'				=> 'ユーザーを増やす必要がある場合は、次のリンクをクリックしてTeam Password Managerウェブサイトから追加ライセンスを購入してください：',
	'c_users_more_than_allowed'	 	=> 'ライセンスで許可されている数よりも多くのアクティブユーザーがいます。この状況が修正されるまで、Team Password Managerを使用することはできません。',
	'c_users_two_options'			=> '対処方法は2つあります',
	...
	'c_users_error_renewing_api_keys' => 'APIキーの更新時にエラーが発生しました。',
	'c_users_error_renewing_api_csrf' => 'APIキーの更新時にCSRFエラーが発生しました。',
	...
	'field_language'				=> '言語',
	'field_pwd'						=> 'パスワード',
	'field_repeat_pwd'				=> 'パスワードをもう一度入力してください',
	...
	'val_username_exists' 			=> 'そのユーザー名はすでに存在しています。',
	'val_username_invalid_chars'	=> 'ユーザー名に無効な文字が含まれています。',
	'val_email_exists' 				=> 'そのメールアドレスはすでに存在しています。',
	'val_it_users_cannot_mg_admins' => 'ITユーザーは、管理者ユーザーを管理（追加、編集、パスワード変更、無効化、削除など）することはできません。',
	'val_it_users_cannot_mg_admins_title' => 'ITユーザーは管理者ユーザーを管理できません',

	'c_users_edit_user'				=> '編集ユーザー',
	'c_users_edit_user_error'		=> 'ユーザー情報を保存する際にエラーが発生しました。',
	...
	'c_users_click_to_purchase'		=> 'ユーザーの追加購入はこちらから',
	'c_users_add_user_error' 		=> 'ユーザーを追加する際にエラーが発生しました。',
	'c_users_add_user_csrf_error'	=> 'ユーザーを追加する際にCSRFエラーが発生しました。',
	...
	'c_users_cpwd_error'			=> 'パスワードを変更する際にエラーが発生しました。',
	'c_users_cpwd_csrf_error'		=> 'パスワードを変更する際にCSRFエラーが発生しました。',

	'c_users_clang'					=> '言語の変更',
	'c_users_clang_error'			=> '言語を変更する際にエラーが発生しました。',
	'c_users_clang_csrf_error'		=> '言語を変更する際にCSRFエラーが発生しました。',
	...
	'c_users_add_user_to_group_no_groups' => 'ユーザーを追加するグループがありません。',
 	...
 	'c_users_set_api_only_not_yourself' => '<strong>自分をAPI専用ユーザーとして設定することはできません。</strong>.他のユーザーを選択してください。',

 	'c_users_unset_api_only'		=> 'API専用ユーザーの設定解除',
 	'c_users_unset_api_only_already' => 'このユーザーはすでにAPI専用ユーザーではありません',
 	'c_users_unset_api_only_not_yourself' => '<strong>自分をAPI専用ユーザーから解除することはできません。</strong>.他のユーザーを選択してください。',

 	'c_users_activate'				=> 'ユーザーをアクティブにする',
 	'c_users_activate_not_yourself' => '<strong>自分をアクティブユーザーにすることはできません</strong>。他のユーザーを選択してください。',
 	'c_users_activate_cannot_more'	=> 'これ以上アクティブユーザーを増やすことはできません。',

 	'c_users_deactivate'			=> 'ユーザーの無効化',
 	'c_users_deactivate_not_yourself' => '<strong>自分を無効にすることはできません</strong>。他のユーザーを選択してください。',
 	...
 	'c_users_change_john'			=> 'ユーザー変更のデモ',
 	'c_users_change_john_impossible' => 'このデモでは、ユーザーJohn Bossの編集、削除、無効化、パスワードの変更ができません。',
 	...
 	'c_users_cnv_ldap_already'		=> 'ユーザーはすでにLDAPユーザーです',

 	'c_users_import_step_1'			=> 'LDAP ユーザのインポートステップ 1: ユーザーを取得するためのデータ',
 	'c_users_import_step_2_import'	=> 'LDAPユーザーをインポートします。ステップ2：インポートするユーザーを選択する',
 	'c_users_import_step_2_debug'	=> 'LDAPユーザーをインポートします。ステップ 2: 取得したデータをデバッグする',
 	'c_users_import_ldap_title'		=> 'LDAPユーザーのインポート',
 	'c_users_imported_ldap_title'	=> 'インポートされたLDAPユーザー',
 	'c_users_import_ldap_error_getting' => 'インポートデータを取得する際ににエラーが発生しました。',
 	...
 	'v_users_btn_search_users'		=> 'ユーザーの検索',
 	...
 	'v_users_list_invalid_hash'		=> '注意：このユーザーのハッシュ値は無効で、サインインできません。誰かがデータベースを改ざんした可能性があります。。この状況を修正するには、ユーザーを編集する必要があります。',
 	'v_users_uinfo_invalid_hash'	=> '注意: ユーザーのハッシュ値が無効で、次回サインインできません。誰かがデータベースを改ざんした可能性があります。管理者にお知らせください。',
 	'v_users_uinfo_invalid_hash_edit' => '注意：このユーザーのハッシュ値は無効で、サインインできません。誰かがデータベースを改ざんした可能性があります。この状況を修正するには、情報を保存してください。特に<strong>ユーザー名</strong>および<strong>役割</strong>のフィールドに注意してください。',
 	...
 	'v_users_roles_desc_admin'		=> 'すべての操作を行えます',
 	'v_users_roles_desc_pm'			=> '通常のユーザーと同様であり、[PRJS]を作成/削除することもできる。',
 	'v_users_roles_desc_normal'		=> 'パスワードと[PRJS]は使えるが、[PRJS]の作成と削除はできない。',
 	'v_users_roles_desc_ro'			=> '割り当てられた[PRJS]のパスワードの読み取りのみ可能',
 	'v_users_roles_desc_it'			=> '[PRJ]マネージャー同様に、ユーザー/グループ、ログ、設定にアクセスできます。',
 	...
 	'v_users_renew_api_keys_not_api_only' => 'このユーザーはAPI専用ユーザーではありません。このユーザーのHMAC API Keysを更新するには、サインインして "マイアカウント"の "APIキー"タブをチェックする必要があります。',
 	...
 	'v_users_unset_api_only_confirm' => 'このユーザーをAPI専用ユーザーから解除しますか？',
 	'v_users_unset_api_only_desc'	=> 'ユーザーはTeam Password Managerにサインインできるだけでなく、API経由でTeam Password Managerにアクセスできるようになります。',

 	'v_users_cnv_normal_desc_1'		=> 'このアクションによりユーザーの<strong>ログインDN</strong>が削除されます。',
 	'v_users_cnv_normal_desc_2'		=> 'このユーザーはTeam Password Managerデータベースに保存されているパスワードを使用してサインインできます。',
 	'v_users_cnv_normal_desc_3'		=> '<strong>* 重要：</strong>このユーザーを通常ユーザーに変換した後、"パスワード変更"ボタンを使用して、このユーザーのパスワードを設定する必要があります。',
 	...
 	'v_users_disable_2fa_confirm_self' => '二要素認証を無効にしますか？',
 	'v_users_disable_2fa_confirm_self_desc' => 'サインインはできますが、二要素認証はありません。',

 	'v_users_ga_generated_token'	=> '生成トークン',
 	'v_users_ga_generated_token_desc' => 'Google Authenticatorが30秒ごとに生成します',
 	...
 	'v_users_enable_2fa_instr_2'	=> 'スマートフォンで<strong>Google Authenticator</strong>を開き、<strong>プラス（＋）ボタン</strong>をタップしてトークンを追加して、<strong>時間ベース</strong>を選択してください。',
 	'v_users_enable_2fa_instr_3'	=> 'Google Authenticator デバイスで<strong>QRコード</strong>をスキャンしてください。お使いの端末にカメラが搭載されていない場合は<strong>アカウント名</strong>および<strong>秘密鍵</strong>を手動で入力してください。',
 	'v_users_enable_2fa_instr_4'	=> 'Google Authenticator が 30 秒ごとに生成する 6 桁のトークンを入力します。',
 	'v_users_enable_2fa_instr_5'	=> '「二要素認証を有効にする」をクリックしてください。',
 	...
 	'v_users_ildap_attr_email'		=> '属性：電子メール',
 	...
 	'v_users_ldap_no_users_created'	=> '作成されたユーザーがありません。',
 	...
 	'v_users_ldap_no_dn_email'		=> 'DNまたはEメールでのエントリーはできません',
 	'v_users_ldap_dn'				=> 'DN',
 	...
 	'v_users_ldap_import_num_users_found' => '見つかったユーザー数',
 	...
 	'c_uinfo_edit_my_account_error'	=> 'データを保存する際にエラーが発生しました。',
 	...
 	'c_uinfo_cpwd_error'			=> 'パスワードを変更する際にエラーが発生しました。',
 	'c_uinfo_cpwd_csrf_error'		=> 'パスワードを変更する際にCSRFエラーが発生しました。',

 	'c_uinfo_clang'					=> '言語を変更する',
 	'c_uinfo_clang_error'			=> '言語を変更する際にエラーが発生しました。',
 	'c_uinfo_clang_csrf_error'		=> '言語を変更する際にCSRFエラーが発生しました。',
 	...
 	'c_uinfo_e2fa_error_gen_key'	=> '秘密鍵を生成する際にエラーが発生しました。',
 	...
 	'c_users_del_ldap_group_from_user' => 'このユーザーからこのグループを削除することはできません。このグループはLDAPグループであり、LDAP同期から実行されるためです。',

 	'c_users_system'				=> 'このユーザーは、ユーザーがログインしていないプロセスで使用されます。例えば、LDAP 同期のような自動化に使用される外部実行プロセスです。',
	...
	'v_users_saml_email'			=> '電子メール・アドレスで、SAML ID プロバイダのユーザを識別します。',
	'lbl_saml'						=> 'SAML',
	...
	'c_users_cnv_normal_saml_not' 	=> 'このユーザーは SAML ユーザではありません。',
	'v_users_cnv_normal_saml_confirm' => 'このユーザーを通常の（SAML ではない）ユーザに変換しますか。',
	'v_users_cnv_normal_saml_desc'	=> 'このアクションにより、ユーザーを SAML ユーザーから通常のユーザに変換します。',
	'c_users_cnv_normal_not'		=> 'このユーザーはLDAPユーザーではありません。',
	'c_users_cnv_ldap_cannot_saml'	=> 'SAML ユーザーを LDAP ユーザーに変換することはできません。',
	'c_users_cnv_saml' 				=> 'SAML ユーザーに変換する',
	'c_users_cnv_saml_cannot_ldap'	=> 'LDAP ユーザーを SAML ユーザーに変換することはできません。',
	'c_users_cnv_saml_already'		=> 'このユーザは既に SAML ユーザです。',
	'c_users_cnv_saml_cannot_ao'	=> 'API専用ユーザーを SAML ユーザーに変換することはできません。',
	'v_users_cnv_saml_confirm'		=> 'このユーザーをSAMLユーザーに変換しますか？',
	'v_users_cnv_saml_desc'			=> 'このアクションにより、ユーザーを通常のユーザーから SAML ユーザーに変換します。',
	'v_users_cnv_saml_desc_2'		=> 'このユーザーは、電子メールを使用して ID プロバイダで認証します：',
	'c_uinfo_cpwd_cannot_saml'		=> 'あなたはSAML ユーザーであるため、パスワードを変更することはできません。',
	'c_2fa_disabled'				=> '二要素認証が無効になっています。',
	'v_users_note_ldap_saml'		=> '<strong>注</strong>:このユーザーはLDAPユーザーとしてプロビジョニングされるが、SAMLを使用して認証されます。',

	// v12
	'v_ad_lowercase'				=> '<strong>注</strong>：<strong>アクティブディレクトリ</strong>を使用している場合、属性を<strong>小文字</strong>にしてください。例：sAMAccountNameではなく、samaccountnameにします。',

	// v13
	'v_upr_same'					=> 'ユーザー名やメールアドレスの一部にすることはできません',
	'v_upr_min_len'					=> '最小 %d 文字', // %d gets replaced by a number
	'v_upr_contain' 				=> '少なくとも以下を含むようにしてください',
	'v_upr_uppercase'				=> '大文字1文字<code>A-Z</code>',
	'v_upr_lowercase'				=> '小文字1文字<code>a-z</code>',
	'v_upr_number' 					=> '数字1文字<code>0-9</code>',
	'v_upr_symbol' 					=> '記号1文字',
	'v_upr_space' 					=> '半角スペース(先頭や末尾には付けないでください)',
